...
*** INICIO MODIF. - 3565 - 10/03/2026 - DEVBT02 Ramón Quintana
        lv_folio    TYPE zisde_folios,
        lv_rsnum    TYPE rsnum,
*** FIN MODIF.    - 3565 - 10/03/2026 - DEVBT02 Ramón Quintana
...
**********************************************************************
  ...
  IF sy-subrc <> 0.
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '002' WITH text-001 DISPLAY LIKE 'E'.
    RAISE falnr_not_found.
  ENDIF.

  "Validar si no tiene folios pendientes
*** INICIO MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
  CALL FUNCTION 'ZISMF_HAS_PEND_FOLIO'
    EXPORTING
      iv_einri = iv_einri   " IS-H: Centro sanitario
      iv_falnr = iv_falnr   " IS-H: Número de episodio
    IMPORTING
      ev_folio = lv_folio   " Folio generado para reserva
      ev_rsnum = lv_rsnum.  "Numero de reserva

  IF lv_folio IS NOT INITIAL.
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '009'
      WITH text-010 lv_folio text-011 DISPLAY LIKE 'E'.
    RAISE creation_failed.
  ELSEIF lv_rsnum IS NOT INITIAL.
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '013'
      WITH text-017 lv_rsnum text-011 DISPLAY LIKE 'E'.
    RAISE creation_failed.
  ENDIF.
...
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
      iv_umedica       = iv_orgfa   " unidad medica
    IMPORTING
...
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
      MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '010' WITH text-012 iv_orgfa DISPLAY LIKE 'E'.
      RAISE creation_failed.
    ENDIF.
  ELSEIF ls_nfal-falar = '2'.
    IF lv_need_pre = abap_false.
      "No necesita pre-alta
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
      MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '007' WITH text-008 iv_orgfa DISPLAY LIKE 'E'.
      RAISE creation_failed.
    ENDIF.
  ENDIF.
  ...
  IF sy-subrc <> 0.
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '003' WITH text-005 DISPLAY LIKE 'E'.
    RAISE creation_failed.
  ENDIF.
  ...
  IF sy-subrc <> 0.
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '004' WITH text-006 iv_orgfa DISPLAY LIKE 'E'.
...
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
      MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '004' WITH text-002 DISPLAY LIKE 'E'.
    ELSE.
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
      MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '008' WITH text-009 DISPLAY LIKE 'W'.
    ENDIF.
...
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '011' WITH text-013 DISPLAY LIKE 'E'.
    RAISE creation_failed.
  ENDIF.
  ...
  IF sy-subrc <> 0.
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
    MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '005' WITH text-003 DISPLAY LIKE 'E'.
    RAISE creation_failed.
  ENDIF.
...
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
  ...
  COMMIT WORK.
*** MODIF. - 3565 - 06/03/2026 - DEVBT02 Ramón Quintana
  MESSAGE ID 'C-LIST' TYPE 'S' NUMBER '006' WITH text-007.
